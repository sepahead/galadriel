# Detailed research and transport workflows

This guide retains the detailed source workflows from the previous README.
...
The retained research results, limitations, and release procedures keep their original evidence scope.
Link locations changed when this material moved.
No detector threshold, release status, or historical result changed.
...
## Historical ecosystem inspection boundaries
...
## Retained source-release status
