...
- [x] Add a cargo-mutants 27.1.0/Rust 1.89 exact-head gate for the seven CREBAIN contract functions. Bind the 155-mutant normalized multiset, 152 caught results, and three exact compile-unviable substitutions.
