...
MUTATION_LIVENESS_EXCLUDE_RES = (
    ...
    r"^crates/galadriel-dependence/src/engine\.rs:341:29: replace > with >= in DeclaredMiInput::try_new_with_origin$",
    r"^crates/galadriel-dependence/src/engine\.rs:821:13: replace > with >= in quadratic_fit_work$",
    r"^crates/galadriel-dependence/src/engine\.rs:2403:37: replace < with <= in canonical_pair$",
    r"^crates/galadriel-dependence/src/suite\.rs:129:39: replace > with == in DependenceResearchSuite::try_new_with_profile$",
    r"^crates/galadriel-dependence/src/suite\.rs:129:39: replace > with >= in DependenceResearchSuite::try_new_with_profile$",
    r"^crates/galadriel-dependence/src/engine\.rs:992:9: replace MiKsgEvaluatorConfigEvidence::tie_epsilon -> f64 with 0\.0$",
    r"^crates/galadriel-dependence/src/engine\.rs:1004:9: replace MiKsgEvaluatorConfigEvidence::support_density_regular -> bool with true$",
    r"^crates/galadriel-dependence/src/engine\.rs:1007:9: replace MiKsgEvaluatorConfigEvidence::support_finite_information -> bool with true$",
    r"^crates/galadriel-dependence/src/engine\.rs:1206:9: replace MiEstimatorEvidence::calibrated_security_role -> bool with false$",
)
...
MUTATION_LIVENESS_CHECKS = (
    ...
    },
    {
        ...
        "examine_re": (
            ...
            r"replace \^ with (\||&) in bootstrap_seed"
        ),
