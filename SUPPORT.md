...
**GLD-090-META-001:** General reproducible defect reports **SHALL** use the GitHub issue tracker.
...
`docs/API-SURFACE.md` defines this policy.
It is not an operational maintenance promise.
